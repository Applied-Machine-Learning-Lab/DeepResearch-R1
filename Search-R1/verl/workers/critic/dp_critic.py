...
class DataParallelPPOCritic(BasePPOCritic):
    ...
    def __init__(self, config, critic_module: nn.Module, critic_optimizer: optim.Optimizer):
        ...
        # === 新增：强制参数检查，防止 Hydra 传值失败导致除以零 ===
        self.config.ppo_mini_batch_size = 8
        self.config.ppo_micro_batch_size = 2
        print(f"DEBUG: Critic force set mini_batch=8, micro_batch=2")
        # =========================================================
